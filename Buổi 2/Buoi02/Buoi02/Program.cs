...
namespace Buoi02
{
    class Program
    {
                    ...
                    case 3:
                        {
                            ...
                            g.FileToAdjMatrix(fileInput); g.Output();
                            // Tạo đường dẫn fileOutput : Storage.txt
                            string fileOutput = "../../TextFile/Bonchua.txt";
        ...
        static void MaxEdge(WeightEdgeList g)
        {
            ...
            foreach(Tuple<int, int, int> edge in g.G)
            {
            ...
            Console.WriteLine($"Số lượng: {lst.Count} cạnh");
